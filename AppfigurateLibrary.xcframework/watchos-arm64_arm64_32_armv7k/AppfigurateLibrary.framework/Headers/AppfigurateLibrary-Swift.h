...
@interface APLPropertyWrapperIntrospection : NSObject
+ (APLPropertyWrapperIntrospection * _Nonnull)shared SWIFT_WARN_UNUSED_RESULT;
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
+ (nonnull instancetype)new SWIFT_UNAVAILABLE_MSG("-init is unavailable");
- (NSDictionary * _Null_unspecified)getPropertyName:(NSString * _Null_unspecified)name configuration:(APLConfiguration * _Null_unspecified)configuration SWIFT_WARN_UNUSED_RESULT;
@end
