...
extern NSString * __nonnull APLStringForAccessibility(APLAccessibility accessibility);
extern void APLAtomicSecItemLock(__nonnull dispatch_block_t block);
...
+ (nonnull id)sharedValetForValet:(nonnull APLValet *)valet;

// Creates a base query given the injected properties. Do not override.
+ (nullable NSMutableDictionary *)mutableBaseQueryWithIdentifier:(nonnull NSString *)identifier accessibility:(APLAccessibility)accessibility initializer:(nonnull SEL)initializer;

// Creates a base query for shared access group Valets given the injected properties. Do not override.
+ (nullable NSMutableDictionary *)mutableBaseQueryWithSharedAccessGroupIdentifier:(nonnull NSString *)sharedAccessGroupIdentifier accessibility:(APLAccessibility)accessibility initializer:(nonnull SEL)initializer;
