...
typedef NS_ENUM(NSUInteger, APLAccessibility) {
    ...
    APLAccessibilityWhenUnlocked = 1,
    ...
    APLAccessibilityAfterFirstUnlock,
    ...
    APLAccessibilityWhenPasscodeSetThisDeviceOnly NS_ENUM_AVAILABLE(10_10, 8_0),
    ...
    APLAccessibilityWhenUnlockedThisDeviceOnly,
    ...
    APLAccessibilityAfterFirstUnlockThisDeviceOnly,
...
// @see APLAccessibility
- (nullable instancetype)initWithSharedAccessGroupIdentifier:(nonnull NSString *)sharedAccessGroupIdentifier accessibility:(APLAccessibility)accessibility NS_DESIGNATED_INITIALIZER;
...
// @return An error if the operation failed. Error domain will be <code>APLMigrationErrorDomain</code>, and codes will be of type <code>APLMigrationError</code>
// @see APLMigrationError
...
// @return An error if the operation failed. Error domain will be <code>APLMigrationErrorDomain</code>, and codes will be of type <code>APLMigrationError</code>
// @see APLMigrationError
- (nullable NSError *)migrateObjectsFromValet:(nonnull APLValet *)valet removeOnCompletion:(BOOL)remove;

+ (nullable NSString *) sharedAccessGroupPrefix;
