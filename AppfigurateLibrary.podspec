...
10.7 The Terms of Service constitute the entire agreement between Electric Bolt and you with respect to the subject matter hereof.
  ...
  s.source                     = { :git => "https://github.com/electricbolt/appfiguratesdk.git", :tag => '1.2.0' }
  s.ios.deployment_target      = '8.0'
  s.watchos.deployment_target  = '2.0'
  s.source_files               = 'AppfigurateLibrary/*.h'
  s.ios.vendored_libraries     = 'AppfigurateLibrary/libAppfigurateLibrary.a'
  s.watchos.vendored_libraries = 'AppfigurateLibrary/libAppfigurateWatchLibrary.a'
